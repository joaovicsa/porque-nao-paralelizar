    ...
    public void create(Produto produto) {
        ...
        try {
            ...
            for (Movimento movimentoListMovimentoToAttach : produto.getMovimentoList()) {
                movimentoListMovimentoToAttach = em.getReference(movimentoListMovimentoToAttach.getClass(),
                        movimentoListMovimentoToAttach.getIdMovimento());
        ...
        try {
            ...
            for (Movimento movimentoListOldMovimento : movimentoListOld) {
                if (!movimentoListNew.contains(movimentoListOldMovimento)) {
                    ...
                    illegalOrphanMessages.add("You must retain Movimento " + movimentoListOldMovimento
                            + " since its produto field is not nullable.");
                }
            }
            if (illegalOrphanMessages != null) {
            ...
            for (Movimento movimentoListNewMovimentoToAttach : movimentoListNew) {
                movimentoListNewMovimentoToAttach = em.getReference(movimentoListNewMovimentoToAttach.getClass(),
                        movimentoListNewMovimentoToAttach.getIdMovimento());
            ...
            for (Movimento movimentoListNewMovimento : movimentoListNew) {
                if (!movimentoListOld.contains(movimentoListNewMovimento)) {
                    ...
                    if (oldProdutoOfMovimentoListNewMovimento != null
                            && !oldProdutoOfMovimentoListNewMovimento.equals(produto)) {
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            for (Movimento movimentoListOrphanCheckMovimento : movimentoListOrphanCheck) {
                ...
                illegalOrphanMessages.add("This Produto (" + produto + ") cannot be destroyed since the Movimento "
                        + movimentoListOrphanCheckMovimento
                        + " in its movimentoList field has a non-nullable produto field.");
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            }
